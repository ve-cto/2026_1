...
public final class Constants {
    public static final class Hardware {
        ...
        public static final int kLoaderId = 99; // probably a cim or a redline
    ...
    public static class Shooter {
        ...
        public static final double maxOutput = 0.95; // Limit the maximum percentage output applied to the shooter motors to avoid overdraw and burning
        // TODO: current/stator limits
    }
